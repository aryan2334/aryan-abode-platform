...
export function DiscoverPanel({ onNavigate }: { onNavigate?: (id: PanelId) => void }) {
  return (
    <div className="h-full min-h-screen grid lg:grid-cols-2 relative overflow-hidden">
      {/* Background mesh */}
      <div
      ...
      {/* ── Left: Copy ── */}
      <div className="flex flex-col justify-center px-10 py-16 lg:pl-14 lg:pr-8 relative z-10">
        <motion.div
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl xl:text-7xl font-semibold tracking-tight text-white leading-[1.02] mb-2">
            Where the
          </h1>
          <h1 className="text-5xl md:text-6xl xl:text-7xl font-semibold tracking-tight leading-[1.02] mb-8">
            <span
              style={{
          ...
          <p className="text-[#c0bcd4] text-lg font-light leading-relaxed max-w-md mb-10">
          ...
          <div className="flex flex-col gap-2.5 mb-10">
            {highlights.map((h, i) => (
              ...
              >
                ...
                <span className="text-[#c8c4dc] text-sm font-light">{h.text}</span>
              </motion.div>
            ))}
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <motion.button
              className="flex items-center gap-2 px-6 py-3 rounded-full text-sm font-bold tracking-[0.12em] uppercase"
            ...
            <motion.button
              className="flex items-center gap-2 px-6 py-3 rounded-full border text-sm font-light tracking-wider transition-all"
        ...
        {/* Stats row */}
        <motion.div
          className="grid grid-cols-4 gap-3 mt-14 pt-8 border-t border-white/20"
      ...
      <div className="relative h-[50vh] lg:h-full">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 pointer-events-none">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-sm" style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.15)" }}>
            <span className="w-1.5 h-1.5 rounded-full bg-[#f0c84a] animate-pulse" />
            <span className="text-[#b0b8d8] text-[11px] tracking-[0.25em] uppercase">
